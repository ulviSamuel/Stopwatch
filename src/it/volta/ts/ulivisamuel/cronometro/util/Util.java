package it.volta.ts.ulivisamuel.cronometro.util;
...
{	
	...
	public static String leggiChar(Scanner scanner, String messaggio, boolean insObbligatorio, String ritornoDefault)
	{
		String valore = "";
		...
		while(valore.length() == 0)
		{
			...
			if(valore.isEmpty() && !insObbligatorio)
				return ritornoDefault;
		}
		
		return  valore.substring(0, 1);
	}
}
